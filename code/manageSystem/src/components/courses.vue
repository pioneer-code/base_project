<template>
    <div class="course">
        <div class="course-title">
            <div class="top">
                 <div class="biaoti">课程安排</div>
                <div class="showTjBtn" v-if="type == 'T' || type == 'A'">
                    <el-button type="primary" @click="showTianjia = true">添加新课程安排</el-button>
                </div>    
            </div>   
            <div class="zhuangshi"></div>
        </div>
        <div class="course-body student" v-if="type == 'S'">
        ...
        <div class="course-body teacher" v-if="type == 'T'">
